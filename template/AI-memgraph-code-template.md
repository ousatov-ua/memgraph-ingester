...
- Regular and watch re-ingestion prune deleted files and removed declarations. Changed-file cleanup and replacement writes are per-file transactional and preserve retained files from other source roots.
