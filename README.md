...
Version in this repository: `12.0.36`.
...
| Platform | Download                                                                                                                                                         |
|---|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Java shaded JAR | [memgraph-ingester.jar](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v12.0.36/memgraph-ingester-12.0.36.jar)                                |
| Linux AMD64 | [memgraph-ingester-linux-amd64.tar.gz](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v12.0.36/memgraph-ingester-12.0.36-linux-amd64.tar.gz)  |
| macOS ARM64 | [memgraph-ingester-macos-arm64.tar.gz](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v12.0.36/memgraph-ingester-12.0.36-darwin-arm64.tar.gz) |
| Windows AMD64 | [memgraph-ingester-windows-amd64.zip](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v12.0.36/memgraph-ingester-12.0.36-windows-amd64.zip)            |
