...
Version in this repository: `12.1.1`.
...
| Platform | Download                                                                                                                                                         |
|---|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Java shaded JAR | [memgraph-ingester.jar](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v12.1.1/memgraph-ingester-12.1.1.jar)                                |
| Linux AMD64 | [memgraph-ingester-linux-amd64.tar.gz](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v12.1.1/memgraph-ingester-12.1.1-linux-amd64.tar.gz)  |
| macOS ARM64 | [memgraph-ingester-macos-arm64.tar.gz](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v12.1.1/memgraph-ingester-12.1.1-darwin-arm64.tar.gz) |
| Windows AMD64 | [memgraph-ingester-windows-amd64.zip](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v12.1.1/memgraph-ingester-12.1.1-windows-amd64.zip)            |
