...
Version in this repository: `9.0.9`.

| Platform | Download                                                                                                                                            |
|---|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| Java shaded JAR | [memgraph-ingester.jar](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v9.0.9/memgraph-ingester.jar)                             |
| Linux AMD64 | [memgraph-ingester-linux-amd64.zip](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v9.0.9/memgraph-ingester-linux-amd64.zip)     |
| macOS ARM64 | [memgraph-ingester-macos-arm64.zip](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v9.0.9/memgraph-ingester-macos-arm64.zip)     |
| Windows AMD64 | [memgraph-ingester-windows-amd64.zip](https://github.com/ousatov-ua/memgraph-ingester/releases/download/v9.0.9/memgraph-ingester-windows-amd64.zip) |
